...
class CardStackShim extends Component<*, CardStackShimProps, *> {
  ...
  render() {
    ...
    return (
      <CardStackTransitioner navigation={navigation} router={this} headerMode="none" mode={this.props.mode} style={{position: 'absolute', left: this.props.hidden ? -9999 : 0, width: '100%', height: '100%'}} />
    )
  }
}
    ...
    const content = (
      <Box style={{height: '100%'}}>
        ...
        {![chatTab].includes(props.routeSelected) ?
          <Offline key="offline" reachable={props.reachable} appFocused={true} /> : null }
